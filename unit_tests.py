...
def unit_tests():
    ...
    # modifier-fields
    assert L.getWordModifier("A1", "A15") == 27
    assert L.getWordModifier("A1", "O1") == 27
    assert L.getWordModifier("A1", "A8") == 9
    assert L.getWordModifier("A1") == 3
    assert L.getWordModifier("A2") == 1
    assert L.getWordModifier("B2", "N2") == 4
    assert L.getWordModifier("B6") == 1

    assert L.getLetterModifier("B2") == 1
    assert L.getLetterModifier("F2") == 3
    assert L.getLetterModifier("B6") == 3
    assert L.getLetterModifier("B1") == 1
    ...
    L.getLetterFromPosition("A5", showJoker = False) == "E"
    L.getLetterFromPosition("A5", showJoker = True) == "?E"
# end of unit_tests()